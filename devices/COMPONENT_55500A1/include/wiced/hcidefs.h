...
/** @file
 *
 * Host Controller Interface definitions
 *
 */
...
#define HCI_INQUIRY                     (0x0001 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0401 */
#define HCI_INQUIRY_CANCEL              (0x0002 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0402 */
#define HCI_PERIODIC_INQUIRY_MODE       (0x0003 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0403 */
#define HCI_EXIT_PERIODIC_INQUIRY_MODE  (0x0004 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0404 */
#define HCI_CREATE_CONNECTION           (0x0005 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0405 */
#define HCI_DISCONNECT                  (0x0006 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0406 */
#define HCI_ADD_SCO_CONNECTION          (0x0007 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0407 */
#define HCI_CREATE_CONNECTION_CANCEL    (0x0008 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0408 */
#define HCI_ACCEPT_CONNECTION_REQUEST   (0x0009 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0409 */
#define HCI_REJECT_CONNECTION_REQUEST   (0x000A | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040A */
#define HCI_LINK_KEY_REQUEST_REPLY      (0x000B | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040B */
#define HCI_LINK_KEY_REQUEST_NEG_REPLY  (0x000C | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040C */
#define HCI_PIN_CODE_REQUEST_REPLY      (0x000D | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040D */
#define HCI_PIN_CODE_REQUEST_NEG_REPLY  (0x000E | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040E */
#define HCI_CHANGE_CONN_PACKET_TYPE     (0x000F | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040F */
#define HCI_AUTHENTICATION_REQUESTED    (0x0011 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0411 */
#define HCI_SET_CONN_ENCRYPTION         (0x0013 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0413 */
#define HCI_CHANGE_CONN_LINK_KEY        (0x0015 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0415 */
#define HCI_TEMP_LINK_KEY               (0x0017 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0417 */
#define HCI_RMT_NAME_REQUEST            (0x0019 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0419 */
#define HCI_RMT_NAME_REQUEST_CANCEL     (0x001A | HCI_GRP_LINK_CONTROL_CMDS) /* 0x041A */
#define HCI_READ_RMT_FEATURES           (0x001B | HCI_GRP_LINK_CONTROL_CMDS) /* 0x041B */
#define HCI_READ_RMT_EXT_FEATURES       (0x001C | HCI_GRP_LINK_CONTROL_CMDS) /* 0x041C */
#define HCI_READ_RMT_VERSION_INFO       (0x001D | HCI_GRP_LINK_CONTROL_CMDS) /* 0x041D */
#define HCI_READ_RMT_CLOCK_OFFSET       (0x001F | HCI_GRP_LINK_CONTROL_CMDS) /* 0x041F */
#define HCI_READ_LMP_HANDLE             (0x0020 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0420 */
#define HCI_SETUP_ESCO_CONNECTION       (0x0028 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0428 */
#define HCI_ACCEPT_ESCO_CONNECTION      (0x0029 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0429 */
#define HCI_REJECT_ESCO_CONNECTION      (0x002A | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042A */
#define HCI_IO_CAPABILITY_REQUEST_REPLY (0x002B | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042B */
#define HCI_USER_CONF_REQUEST_REPLY     (0x002C | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042C */
#define HCI_USER_CONF_VALUE_NEG_REPLY   (0x002D | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042D */
#define HCI_USER_PASSKEY_REQ_REPLY      (0x002E | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042E */
#define HCI_USER_PASSKEY_REQ_NEG_REPLY  (0x002F | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042F */
#define HCI_REM_OOB_DATA_REQ_REPLY      (0x0030 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0430 */
#define HCI_REM_OOB_DATA_REQ_NEG_REPLY  (0x0033 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0433 */
#define HCI_IO_CAP_REQ_NEG_REPLY        (0x0034 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0434 */

/* AMP HCI */
#define HCI_CREATE_PHYSICAL_LINK        (0x0035 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0435 */
#define HCI_ACCEPT_PHYSICAL_LINK        (0x0036 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0436 */
#define HCI_DISCONNECT_PHYSICAL_LINK    (0x0037 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0437 */
#define HCI_CREATE_LOGICAL_LINK         (0x0038 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0438 */
#define HCI_ACCEPT_LOGICAL_LINK         (0x0039 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0439 */
#define HCI_DISCONNECT_LOGICAL_LINK     (0x003A | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043A */
#define HCI_LOGICAL_LINK_CANCEL         (0x003B | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043B */
#define HCI_FLOW_SPEC_MODIFY            (0x003C | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043C */
/* End of AMP HCI */

#define HCI_ENH_SETUP_ESCO_CONNECTION   (0x003D | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043D */
#define HCI_ENH_ACCEPT_ESCO_CONNECTION  (0x003E | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043E */

/* ConnectionLess Broadcast */
#define HCI_TRUNCATED_PAGE              (0x003F | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043F */
#define HCI_TRUNCATED_PAGE_CANCEL       (0x0040 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0440 */
#define HCI_SET_CLB                     (0x0041 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0441 */
#define HCI_RECEIVE_CLB                 (0x0042 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0442 */
#define HCI_START_SYNC_TRAIN            (0x0043 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0443 */
#define HCI_RECEIVE_SYNC_TRAIN          (0x0044 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0444 */

/* Secure Connections (SC)*/
#define HCI_REM_OOB_EXT_DATA_REQ_REPLY  (0x0045 | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0445 */
...
#define HCI_HOLD_MODE                   (0x0001 | HCI_GRP_LINK_POLICY_CMDS) /* 0x0801 */
#define HCI_SNIFF_MODE                  (0x0003 | HCI_GRP_LINK_POLICY_CMDS) /* 0x0803 */
#define HCI_EXIT_SNIFF_MODE             (0x0004 | HCI_GRP_LINK_POLICY_CMDS) /* 0x0804 */
#define HCI_PARK_MODE                   (0x0005 | HCI_GRP_LINK_POLICY_CMDS) /* 0x0805 */
#define HCI_EXIT_PARK_MODE              (0x0006 | HCI_GRP_LINK_POLICY_CMDS) /* 0x0806 */
#define HCI_QOS_SETUP                   (0x0007 | HCI_GRP_LINK_POLICY_CMDS) /* 0x0807 */
#define HCI_ROLE_DISCOVERY              (0x0009 | HCI_GRP_LINK_POLICY_CMDS) /* 0x0809 */
#define HCI_SWITCH_ROLE                 (0x000B | HCI_GRP_LINK_POLICY_CMDS) /* 0x080B */
#define HCI_READ_POLICY_SETTINGS        (0x000C | HCI_GRP_LINK_POLICY_CMDS) /* 0x080C */
#define HCI_WRITE_POLICY_SETTINGS       (0x000D | HCI_GRP_LINK_POLICY_CMDS) /* 0x080D */
#define HCI_READ_DEF_POLICY_SETTINGS    (0x000E | HCI_GRP_LINK_POLICY_CMDS) /* 0x080E */
#define HCI_WRITE_DEF_POLICY_SETTINGS   (0x000F | HCI_GRP_LINK_POLICY_CMDS) /* 0x080F */
#define HCI_FLOW_SPECIFICATION          (0x0010 | HCI_GRP_LINK_POLICY_CMDS) /* 0x0810 */
#define HCI_SNIFF_SUB_RATE              (0x0011 | HCI_GRP_LINK_POLICY_CMDS) /* 0x0811 */
...
//#define HCI_BLE_WRITE_LOCAL_SPT_FEAT    (0x0004 | HCI_GRP_BLE_CMDS) /* 0x2004 */
#define HCI_BLE_WRITE_RANDOM_ADDR       (0x0005 | HCI_GRP_BLE_CMDS) /* 0x2005 */
#define HCI_BLE_WRITE_ADV_PARAMS        (0x0006 | HCI_GRP_BLE_CMDS) /* 0x2006 */
#define HCI_BLE_READ_ADV_CHNL_TX_POWER  (0x0007 | HCI_GRP_BLE_CMDS) /* 0x2007 */
#define HCI_BLE_WRITE_ADV_DATA          (0x0008 | HCI_GRP_BLE_CMDS) /* 0x2008 */
#define HCI_BLE_WRITE_SCAN_RSP_DATA     (0x0009 | HCI_GRP_BLE_CMDS) /* 0x2009 */
#define HCI_BLE_WRITE_ADV_ENABLE        (0x000A | HCI_GRP_BLE_CMDS) /* 0x200A */
#define HCI_BLE_WRITE_SCAN_PARAMS       (0x000B | HCI_GRP_BLE_CMDS) /* 0x200B */
#define HCI_BLE_WRITE_SCAN_ENABLE       (0x000C | HCI_GRP_BLE_CMDS) /* 0x200C */
#define HCI_BLE_CREATE_LL_CONN          (0x000D | HCI_GRP_BLE_CMDS) /* 0x200D */
#define HCI_BLE_CREATE_CONN_CANCEL      (0x000E | HCI_GRP_BLE_CMDS) /* 0x200E */
#define HCI_BLE_READ_FILTER_ACCEPT_LIST_SIZE    (0x000F | HCI_GRP_BLE_CMDS) /* 0x200F */
#define HCI_BLE_CLEAR_FILTER_ACCEPT_LIST        (0x0010 | HCI_GRP_BLE_CMDS) /* 0x2010 */
#define HCI_BLE_ADD_FILTER_ACCEPT_LIST          (0x0011 | HCI_GRP_BLE_CMDS) /* 0x2011 */
#define HCI_BLE_REMOVE_FILTER_ACCEPT_LIST       (0x0012 | HCI_GRP_BLE_CMDS) /* 0x2012 */
#define HCI_BLE_UPD_LL_CONN_PARAMS              (0x0013 | HCI_GRP_BLE_CMDS) /* 0x2013 */
#define HCI_BLE_SET_HOST_CHNL_CLASS             (0x0014 | HCI_GRP_BLE_CMDS) /* 0x2014 */
#define HCI_BLE_READ_CHNL_MAP                   (0x0015 | HCI_GRP_BLE_CMDS) /* 0x2015 */
#define HCI_BLE_READ_REMOTE_FEAT                (0x0016 | HCI_GRP_BLE_CMDS) /* 0x2016 */
#define HCI_BLE_ENCRYPT                         (0x0017 | HCI_GRP_BLE_CMDS) /* 0x2017 */
#define HCI_BLE_RAND                            (0x0018 | HCI_GRP_BLE_CMDS) /* 0x2018 */
#define HCI_BLE_START_ENC                       (0x0019 | HCI_GRP_BLE_CMDS) /* 0x2019 */
#define HCI_BLE_LTK_REQ_REPLY                   (0x001A | HCI_GRP_BLE_CMDS) /* 0x201A */
#define HCI_BLE_LTK_REQ_NEG_REPLY               (0x001B | HCI_GRP_BLE_CMDS) /* 0x201B */
#define HCI_BLE_READ_SUPPORTED_STATES           (0x001C | HCI_GRP_BLE_CMDS) /* 0x201C */
#define HCI_BLE_RECEIVER_TEST                   (0x001D | HCI_GRP_BLE_CMDS) /* 0x201D */
#define HCI_BLE_TRANSMITTER_TEST                (0x001E | HCI_GRP_BLE_CMDS) /* 0x201E */
#define HCI_BLE_TEST_END                        (0x001F | HCI_GRP_BLE_CMDS) /* 0x201F */
#define HCI_BLE_RC_PARAM_REQ_REPLY              (0x0020 | HCI_GRP_BLE_CMDS) /* 0x2020 */
#define HCI_BLE_RC_PARAM_REQ_NEG_REPLY          (0x0021 | HCI_GRP_BLE_CMDS) /* 0x2021 */
#define HCI_BLE_SET_DATA_LENGTH                 (0x0022 | HCI_GRP_BLE_CMDS) /* 0x2022 */
#define HCI_BLE_READ_DFLT_DATA_LENGTH           (0x0023 | HCI_GRP_BLE_CMDS) /* 0x2023 */
#define HCI_BLE_WRITE_DFLT_DATA_LENGTH          (0x0024 | HCI_GRP_BLE_CMDS) /* 0x2024 */
#define HCI_BLE_ADD_DEV_RESOLVING_LIST          (0x0027 | HCI_GRP_BLE_CMDS) /* 0x2027 */
#define HCI_BLE_RM_DEV_RESOLVING_LIST           (0x0028 | HCI_GRP_BLE_CMDS) /* 0x2028 */
#define HCI_BLE_CLEAR_RESOLVING_LIST            (0x0029 | HCI_GRP_BLE_CMDS) /* 0x2029 */
#define HCI_BLE_READ_RESOLVING_LIST_SIZE        (0x002A | HCI_GRP_BLE_CMDS) /* 0x202A */
#define HCI_BLE_READ_RESOLVABLE_ADDR_PEER       (0x002B | HCI_GRP_BLE_CMDS) /* 0x202B */
#define HCI_BLE_READ_RESOLVABLE_ADDR_LOCAL      (0x002C | HCI_GRP_BLE_CMDS) /* 0x202C */
#define HCI_BLE_SET_ADDR_RESOLUTION_ENABLE      (0x002D | HCI_GRP_BLE_CMDS) /* 0x202D */
#define HCI_BLE_SET_RAND_PRIV_ADDR_TIMOUT       (0x002E | HCI_GRP_BLE_CMDS) /* 0x202E */
#define HCI_BLE_SET_RAND_PRIV_ADDR_TIMEOUT_V2   (0x009E | HCI_GRP_BLE_CMDS) /* 0x209E */


#define HCI_BLE_READ_PHY                    (0x0030 | HCI_GRP_BLE_CMDS) /* 0x2030 */
#define HCI_BLE_SET_DEFAULT_PHY             (0x0031 | HCI_GRP_BLE_CMDS) /* 0x2031 */
#define HCI_BLE_SET_PHY                     (0x0032 | HCI_GRP_BLE_CMDS) /* 0x2032 */

/* ADV extension */
#define HCI_BLE_SET_ADV_SET_RANDOM_ADDR     (0x0035 | HCI_GRP_BLE_CMDS) /* 0x2035 */
#define HCI_BLE_SET_EXT_ADV_PARAMETERS      (0x0036 | HCI_GRP_BLE_CMDS) /* 0x2036 */
#define HCI_BLE_SET_EXT_ADV_DATA            (0x0037 | HCI_GRP_BLE_CMDS) /* 0x2037 */
#define HCI_BLE_SET_EXT_SCAN_RSP_DATA       (0x0038 | HCI_GRP_BLE_CMDS) /* 0x2038 */
#define HCI_BLE_SET_EXT_ADV_ENABLE          (0x0039 | HCI_GRP_BLE_CMDS) /* 0x2039 */
#define HCI_BLE_READ_MAX_ADV_DATA_LEN       (0x003A | HCI_GRP_BLE_CMDS) /* 0x203A */
#define HCI_BLE_READ_NUM_OF_SUPPORTED_ADV_SETS   (0x003B | HCI_GRP_BLE_CMDS) /* 0x203B */
#define HCI_BLE_REMOVE_ADV_SET              (0x003C | HCI_GRP_BLE_CMDS) /* 0x203C */
#define HCI_BLE_CLEAR_ADV_SETS              (0x003D | HCI_GRP_BLE_CMDS) /* 0x203D */
#define HCI_BLE_SET_PERIODIC_ADV_PARAMS     (0x003E | HCI_GRP_BLE_CMDS) /* 0x203E */
#define HCI_BLE_SET_PERIODIC_ADV_DATA       (0x003F | HCI_GRP_BLE_CMDS) /* 0x203F */
#define HCI_BLE_SET_PERIODIC_ADV_ENABLE     (0x0040 | HCI_GRP_BLE_CMDS) /* 0x2040 */
#define HCI_BLE_SET_EXT_SCAN_PARAMETERS     (0x0041 | HCI_GRP_BLE_CMDS) /* 0x2041 */

#define HCI_BLE_SET_EXT_SCAN_ENABLE         (0x0042 | HCI_GRP_BLE_CMDS) /* 0x2042 */
#define HCI_BLE_EXT_CREATE_CONNECTION       (0x0043 | HCI_GRP_BLE_CMDS) /* 0x2043 */
#define HCI_BLE_PERIODIC_ADV_CREATE_SYNC    (0x0044 | HCI_GRP_BLE_CMDS) /* 0x2044 */
...
#define HCI_BLE_READ_ISOC_LINK_QUALITY      (0x0075U | HCI_GRP_BLE_CMDS)
...
#define HCI_BLE_CHANNEL_SELECTION_ALOGRITHM_EVT     0x14
...
#define HCI_BLE_PAWR_SYNC_XFER_RECV_EVT             0x26
...
#define HCI_SUPP_COMMANDS_CENTRAL_LINK_KEY_MASK  0x04
#define HCI_SUPP_COMMANDS_CENTRAL_LINK_KEY_OFF   2
#define HCI_CENTRAL_LINK_KEY_SUPPORTED(x)  ((x)[HCI_SUPP_COMMANDS_CENTRAL_LINK_KEY_OFF] & HCI_SUPP_COMMANDS_CENTRAL_LINK_KEY_MASK)
...
#define HCI_SUPP_COMMANDS_LE_SET_RAND_PRIV_ADDR_TIMEOUT_V2_MASK          0x04
#define HCI_SUPP_COMMANDS_LE_SET_RAND_PRIV_ADDR_TIMEOUT_V2_OFF           48
#define HCI_LE_COMMAND_SET_RAND_PRIV_ADDR_TIMEOUT_V2_SUPPORTED(x)      ((x)[HCI_SUPP_COMMANDS_LE_SET_RAND_PRIV_ADDR_TIMEOUT_V2_OFF] & HCI_SUPP_COMMANDS_LE_SET_RAND_PRIV_ADDR_TIMEOUT_V2_MASK)
