...
enum ble_uuid_service
{
    ...
    WICED_BT_UUID_AUDIO_INPUT_CONTROL = 0x1843,           // 43 18
    WICED_BT_UUID_VOLUME_CONTROL = 0x1844,                // 44 18
    WICED_BT_UUID_VOLUME_OFFSET_CONTROL = 0x1845,         // 45 18
    WICED_BT_UUID_COORDINATE_SET_IDENTIFICATION = 0x1846, // 46 18
    WICED_BT_UUID_MEDIA_CONTROL = 0x1848,                 // 48 18
    WICED_BT_UUID_GENERIC_MEDIA_CONTROL = 0X1849,         // 49 18
    WICED_BT_UUID_TELEPHONE_BEARER = 0x184B,              // 4B 18
    WICED_BT_UUID_GENERIC_TELEPHONE_BEARER = 0X184C,      // 4C 18
    WICED_BT_UUID_MICROPHONE_CONTROL = 0x184D,            // 4D 18
    WICED_BT_UUID_AUDIO_STREAM_CONTROL = 0x184E,          // 4e 18
    WICED_BT_UUID_BROADCAST_AUDIO_SCAN = 0X184F,          // 4f 18
    WICED_BT_UUID_PUBLISHED_AUDIO_CAPABILITY = 0x1850,    // 50 18
    WICED_BT_UUID_BASIC_AUDIO_ANNOUNCEMENT = 0X1851,      // 51 18
    WICED_BT_UUID_BROADCAST_AUDIO_ANNOUNCEMENT = 0x1852,  // 52 18
    WICED_BT_UUID_COMMON_AUDIO = 0X1853,                  // 53 18
    ...
    WICED_BT_UUID_GAMING_AUDIO_SERVICE = 0x1858,          // 58 18
};
...
enum ble_uuid_attribute
{
    ...
    WICED_BT_UUID_GMAP_ROLE = 0x2C00,
    WICED_BT_UUID_GMAP_UGG_FEATURES = 0x2C01,
    WICED_BT_UUID_GMAP_UGT_FEATURES = 0x2C02,
    WICED_BT_UUID_GMAP_BGS_FEATURES = 0x2C03,
    WICED_BT_UUID_GMAP_BGR_FEATURES = 0x2C04,
